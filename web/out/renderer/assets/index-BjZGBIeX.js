...
function AuthProvider({ children }) {
	const [apiKey, setApiKey] = (0, import_react.useState)(() => localStorage.getItem("hermes_api_key"));
	const login = (0, import_react.useCallback)(async (key) => {
		try {
			if ((await fetch(`/健康/健康`, { headers: { "Authorization": `Bearer ${key}` } })).ok) {
				setApiKey(key);
...
//#endregion
//#region src/components/layout/TitleBar.tsx
function TitleBar({ onMinimize, onMaximize, onClose, pythonConnected }) {
		...
		children: [
			...
			/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
				...
				children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
					...
					children: "起源信标 · ResonanceBeacon"
				})
			}),
			/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
				className: "flex items-center gap-2",
				style: { WebkitAppRegion: "no-drag" },
				children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { className: `w-2 h-2 rounded-full ${pythonConnected ? "bg-green-500" : "bg-red-500"}` }), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
					className: "text-xs text-gray-500",
					children: pythonConnected ? "后端在线" : "后端离线"
				})]
			})
		]
	});
...
//#endregion
//#region src/components/layout/NavRail.tsx
var navItems = [
	{
		to: "/",
		label: "仪表板",
...
function NavRail() {
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
		className: "flex flex-col items-center w-12 py-2 gap-1 bg-[#0d0d14]",
		children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
			...
			children: navItems.map(({ to, label, icon: Icon }) => {
				return /* @__PURE__ */ (0, import_jsx_runtime.jsx)("button", {
					title: label,
					onClick: () => navigate(to),
					className: `flex items-center justify-center w-9 h-9 rounded-lg transition-colors ${isActive(to) ? "bg-[#6c5ce7]/10 text-[#a29bfe]" : "text-[#6b7280] hover:bg-[#1f1f38] hover:text-[#d1d5db]"}`,
...
var statusTagClass = (status) => {
	switch (status) {
		case "running":
		case "online": return "bg-green-900/40 text-green-400 border border-green-800/30";
		case "idle": return "bg-yellow-900/40 text-yellow-400 border border-yellow-800/30";
		case "failed":
		case "offline": return "bg-red-900/40 text-red-400 border border-red-800/30";
		default: return "bg-dark-700/40 text-dark-300 border border-dark-600/30";
	}
};
...
function Sidebar() {
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
		className: "w-[200px] flex flex-col overflow-y-auto border-r border-white/5",
		...
		children: [
			/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
				...
				children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
					...
					children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
						...
						className: "text-[10px] px-1.5 py-0.5 rounded-full bg-purple-900/40 text-purple-400 border border-purple-800/30",
						children: runningCount
					})]
				}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
					className: "space-y-2",
					children: mockPipelines.map((p) => /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
						className: "group cursor-pointer",
						children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
							className: "flex items-center justify-between mb-0.5",
							children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
								className: "text-xs text-gray-300 truncate max-w-[110px]",
								children: p.name
							}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
								className: `text-[9px] px-1 py-0.5 rounded ${statusTagClass(p.status)}`,
								children: statusLabel(p.status)
							})]
						}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
							className: "w-full h-1 rounded-full bg-white/5",
							children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
			...
			/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { className: "border-t border-white/5 mx-3" }),
			/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
				className: "p-3",
				children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
					className: "flex items-center justify-between mb-3",
					children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
						...
						className: "text-[10px] px-1.5 py-0.5 rounded-full bg-green-900/40 text-green-400 border border-green-800/30",
						children: onlineCount
					})]
				}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
					className: "space-y-2",
					children: mockAgents.map((a) => /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
						...
						children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
							...
							className: `text-[9px] px-1 py-0.5 rounded ${statusTagClass(a.status)}`,
...
//#endregion
//#region src/components/layout/HermesChat.tsx
...
function HermesChat() {
	...
	const sendMessage = async () => {
		...
		setLoading(true);
		try {
			const res = await fetch(`/智能体/hermes/chat`, {
				method: "POST",
			...
			const hermesMsg = {
				role: "hermes",
				content: (await res.json()).reply
			};
			setMessages((prev) => [...prev, hermesMsg]);
		} catch {
			setMessages((prev) => [...prev, {
				role: "hermes",
				content: "抱歉，我暂时无法连接后端"
			}]);
		} finally {
			setLoading(false);
		}
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
		...
		children: [
			/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
				className: "flex items-center gap-4 px-4 h-10 border-b border-white/5 shrink-0",
				children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
					className: "text-xs text-gray-500 cursor-default select-none",
					children: "日志"
				}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
					className: "text-xs font-medium text-purple-400 cursor-default select-none border-b-2 border-purple-500 pb-[10px] -mb-px",
					children: "Hermes 对话"
				})]
			}),
			/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
				...
				children: [
					messages.map((msg, i) => /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
						...
						children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
							className: `w-6 h-6 rounded-full flex items-center justify-center shrink-0 text-[10px] font-bold ${msg.role === "hermes" ? "bg-purple-600/20 text-purple-400" : "bg-gray-600/30 text-gray-400"}`,
							children: msg.role === "hermes" ? "✦" : "你"
						}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
							className: `max-w-[220px] rounded-lg px-3 py-2 text-xs leading-relaxed ${msg.role === "hermes" ? "border border-purple-500/10" : "border border-purple-500/20"}`,
							style: { backgroundColor: msg.role === "hermes" ? "rgba(108,92,231,0.06)" : "rgba(108,92,231,0.12)" },
							children: parseBold(msg.content).map((part, j) => typeof part === "string" ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
					...
					loading && /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
						...
						children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
							className: "w-6 h-6 rounded-full flex items-center justify-center shrink-0 bg-purple-600/20 text-purple-400 text-[10px] font-bold",
							children: "✦"
						}), /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
			...
			/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
				className: "border-t border-white/5 px-3 py-2 shrink-0",
				children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
					className: "flex items-center gap-2",
...
function Layout() {
	const [pythonConnected, setPythonConnected] = (0, import_react.useState)(true);
	(0, import_react.useEffect)(() => {
		if (window.electronAPI?.onPythonStatusChange) window.electronAPI.onPythonStatusChange((data) => {
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
		...
		children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(TitleBar, {
			...
			children: [
				...
				/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
					className: "w-[300px] border-l border-white/5 flex flex-col",
					style: { backgroundColor: "#0d0d14" },
					children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(HermesChat, {})
				})
			]
		})]
	});
...
var api = {
	pipeline: {
		list: () => request("/流水线/"),
		get: (id) => request(`/流水线/${id}`),
		create: (data) => request("/流水线/", {
			method: "POST",
			body: JSON.stringify(data)
		}),
		run: (id, data) => request(`/流水线/${id}/运行`, {
			method: "POST",
			body: JSON.stringify(data ?? { 流水线ID: id })
		}),
		cancel: (id) => request(`/流水线/${id}/取消`, { method: "POST" }),
		stages: (id) => request(`/流水线/${id}/阶段`),
		artifacts: (id) => request(`/流水线/${id}/制品`)
	},
	agent: {
		list: () => request("/智能体/"),
		get: (id) => request(`/智能体/${id}`),
		health: (id) => request(`/智能体/${id}/健康检查`),
		load: (id) => request(`/智能体/${id}/负载`)
	},
	approval: {
		pending: () => request("/审批/待处理"),
		get: (id) => request(`/审批/${id}`),
		decide: (id, data) => request(`/审批/${id}/决策`, {
			method: "POST",
			body: JSON.stringify(data)
		}),
		history: () => request("/审批/历史")
	},
	config: {
		get: () => request("/配置/"),
		merged: () => request("/配置/合并后"),
		update: (keyPath, value) => request(`/配置/${keyPath}`, {
			method: "PUT",
	...
	hermes: { chat: (data) => request("/智能体/hermes/chat", {
		method: "POST",
		body: JSON.stringify(data)
	}) }
};
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
		...
		children: [title && /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
			...
			children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("h3", {
				className: "text-sm font-semibold text-dark-200",
				children: title
			}), action]
		}), children]
	});
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
		...
		children: [
			/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
				className: "text-xs text-dark-400 mb-1",
				children: label
			}),
			/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
				className: `text-2xl font-bold ${color} font-mono`,
				children: value
			}),
...
function StatusBadge({ status }) {
	return /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
		className: variantMap[statusToVariant[status] ?? "neutral"],
		children: status
	});
}
...
function Loading() {
	return /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
		...
		children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(LoaderCircle, { className: "w-6 h-6 text-accent-500 animate-spin" })
	});
}
//#endregion
...
function Dashboard() {
	...
	(0, import_react.useEffect)(() => {
		api.health.check().then(() => setBackendOnline(true)).catch(() => setBackendOnline(false));
	}, []);
	useQuery({
		queryKey: ["health"],
	...
	if (backendOnline === null) return /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
		className: "flex items-center justify-center h-full",
		children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
			className: "text-center",
			children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { className: "animate-spin w-8 h-8 border-2 border-[#6c5ce7] border-t-transparent rounded-full mx-auto mb-4" }), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
				className: "text-sm text-[#6b7280]",
				children: "正在连接后端服务..."
			})]
		})
	});
	if (!backendOnline) return /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
		className: "flex items-center justify-center h-full",
		children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
			className: "max-w-md text-center space-y-6",
			children: [
				/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
					className: "w-16 h-16 rounded-2xl bg-gradient-to-br from-[#6c5ce7] to-[#a29bfe] flex items-center justify-center mx-auto shadow-lg shadow-[#6c5ce7]/20",
					children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Rocket, { className: "w-8 h-8 text-white" })
				}),
				...
				/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
					...
					children: "智能流水线开发系统 · Hermes Agent 元智能体调度平台"
				}),
				/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
					className: "bg-[#1a1a2e]/60 border border-[#6c5ce7]/10 rounded-xl p-5 text-left space-y-3",
					children: [
						/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
						...
						/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
							...
							children: "请确认 Python 后端已启动。运行以下命令："
						}),
						/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
							className: "bg-black/40 rounded-lg p-3 font-mono text-xs text-[#a29bfe] select-all",
							children: [
				...
				/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
					...
					children: [
						/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
							className: "bg-[#1a1a2e]/40 rounded-lg p-3 border border-white/5",
							children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
								className: "text-[#a29bfe] text-sm font-medium mb-1",
								children: "流水线"
							}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
						...
						/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
							...
							children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
								...
								className: "text-[#6b7280] text-xs",
								children: "Claude Code · OpenCode · Codex"
							})]
						}),
						/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
							className: "bg-[#1a1a2e]/40 rounded-lg p-3 border border-white/5",
	...
	if (isLoading) return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Loading, {});
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
		className: "space-y-6",
		children: [
			/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
				...
				children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("h1", {
					...
					className: "px-4 py-2 rounded-lg bg-gradient-to-r from-[#6c5ce7] to-[#a29bfe] text-white text-sm font-medium hover:shadow-lg hover:shadow-[#6c5ce7]/20 transition-all flex items-center gap-2",
					children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Play, { className: "w-4 h-4" }), " 新建流水线"]
				})]
			}),
			/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
			...
			/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
				...
				children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Card, {
					...
					action: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Link, {
						to: "/pipelines",
						className: "text-xs text-[#a29bfe] hover:text-[#c4b5fd]",
						children: "查看全部"
					}),
					children: pipelines.length === 0 ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
						className: "text-center py-8 text-sm text-[#6b7280]",
						children: "暂无流水线"
					}) : /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
						className: "space-y-2",
						children: pipelines.slice(0, 5).map((p) => /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Link, {
							to: `/pipelines/${p.ID}`,
							className: "flex items-center justify-between p-3 rounded-md bg-black/20 hover:bg-[#1a1a2e]/60 transition-colors",
							children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
								className: "flex items-center gap-3",
								children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(GitBranch, { className: "w-4 h-4 text-[#6b7280]" }), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
									className: "text-sm text-white/60",
									children: p.名称
								})]
							}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)(StatusBadge, { status: p.状态 })]
						}, p.ID))
					})
					...
					children: agents.length === 0 ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
						...
						children: agents.map((a) => /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Link, {
							...
							children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
								className: "flex items-center gap-3",
								children: [
									/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Bot, { className: "w-4 h-4 text-[#6b7280]" }),
									/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
										className: "text-sm text-white/60",
										children: a.名称
									}),
							...
							}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)(StatusBadge, { status: a.状态 })]
						}, a.ID))
					})
				})]
			}),
			pendingCount > 0 && /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Card, {
				title: "待审批请求",
				action: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Link, {
					to: "/approvals",
					className: "text-xs text-[#f59e0b]",
					children: [pendingCount, " 项待处理"]
				}),
				children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
					className: "flex items-center gap-3 p-3 rounded-md bg-[#f59e0b]/5 border border-[#f59e0b]/10",
					children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(SquareCheckBig, { className: "w-4 h-4 text-[#f59e0b]" }), /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("span", {
...
function ErrorDisplay({ message, onRetry }) {
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
		className: "flex flex-col items-center justify-center py-12 text-dark-400",
		children: [
			/* @__PURE__ */ (0, import_jsx_runtime.jsx)(CircleAlert, { className: "w-8 h-8 text-cyber-red mb-3" }),
			/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
			...
			onRetry && /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("button", {
				...
				children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(RefreshCw, { className: "w-3.5 h-3.5" }), "重试"]
			})
		]
	});
}
//#endregion
//#region src/pages/Pipelines.tsx
function Pipelines() {
	...
	const runMut = useMutation({
		mutationFn: (id) => api.pipeline.run(id),
		onSuccess: () => qc.invalidateQueries({ queryKey: ["pipelines"] })
	});
	const cancelMut = useMutation({
		mutationFn: (id) => api.pipeline.cancel(id),
		onSuccess: () => qc.invalidateQueries({ queryKey: ["pipelines"] })
	});
	if (isLoading) return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Loading, {});
	if (error) return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(ErrorDisplay, {
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
		...
		}), pipelines.length === 0 ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Card, { children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
			className: "text-sm text-dark-500 text-center py-8",
			children: "暂无流水线数据"
		}) }) : /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
			className: "space-y-3",
			children: pipelines.map((p) => /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
				className: "card-hover flex items-center justify-between",
				children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
					className: "flex items-center gap-4 min-w-0",
					children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(GitBranch, { className: "w-4 h-4 text-dark-400 shrink-0" }), /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
						className: "min-w-0",
						children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Link, {
							to: `/pipelines/${p.ID}`,
							className: "text-sm text-dark-100 hover:text-accent-400 transition-colors truncate block",
							children: p.名称
						}), /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
							...
							children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
								...
								children: p.ID
							}), p.阶段数 > 0 && /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("span", {
					...
					children: [
						/* @__PURE__ */ (0, import_jsx_runtime.jsx)(StatusBadge, { status: p.状态 }),
						p.状态 === "pending" && /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("button", {
							onClick: () => runMut.mutate(p.ID),
							disabled: runMut.isPending,
							className: "btn-success flex items-center gap-1.5 text-xs py-1.5 px-3",
							children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Play, { className: "w-3 h-3" }), " 运行"]
						}),
						p.状态 === "running" && /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("button", {
							onClick: () => cancelMut.mutate(p.ID),
							disabled: cancelMut.isPending,
							className: "btn-danger flex items-center gap-1.5 text-xs py-1.5 px-3",
							children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(CircleX, { className: "w-3 h-3" }), " 取消"]
						}),
...
//#endregion
//#region src/pages/PipelineDetail.tsx
function PipelineDetail() {
	...
	if (pipelineQ.isLoading) return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Loading, {});
	if (pipelineQ.error) return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(ErrorDisplay, {
		message: pipelineQ.error.message,
		onRetry: () => pipelineQ.refetch()
	});
		...
		children: [
			/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
				...
				children: [
					...
					/* @__PURE__ */ (0, import_jsx_runtime.jsx)(GitBranch, { className: "w-5 h-5 text-cyber-blue" }),
			...
			/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
				...
				children: [
					/* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Card, { children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
						className: "text-xs text-dark-500 mb-1",
						children: "ID"
					}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
						className: "text-sm text-dark-200 font-mono",
						children: p.ID
					})] }),
					/* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Card, { children: [
						...
						p.阶段数 > 0 && /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
							className: "mt-2 h-1.5 bg-dark-700 rounded-full overflow-hidden",
							children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
					...
					/* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Card, { children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
						...
						className: "flex gap-2",
						children: [(p.状态 === "pending" || p.状态 === "failed") && /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("button", {
							onClick: () => runMut.mutate(),
							disabled: runMut.isPending,
							className: "btn-success text-xs py-1.5",
							children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Play, { className: "w-3 h-3 inline mr-1" }), " 运行"]
						}), p.状态 === "running" && /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("button", {
							onClick: () => cancelMut.mutate(),
							disabled: cancelMut.isPending,
							className: "btn-danger text-xs py-1.5",
							children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(CircleX, { className: "w-3 h-3 inline mr-1" }), " 取消"]
						})]
					})] })
				]
			}),
			/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Card, {
				...
				children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
					...
					children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Layers, { className: "w-4 h-4" }), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
						className: "text-sm",
						children: stagesQ.data?.阶段列表 ? `${Array.isArray(stagesQ.data?.阶段列表) ? (stagesQ.data?.阶段列表).length : 0} 个阶段` : "暂无阶段信息"
					})]
				})
			}),
			/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Card, {
				...
				children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
					className: "flex items-center gap-2 text-dark-500",
					children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Package, { className: "w-4 h-4" }), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
						className: "text-sm",
						children: artifactsQ.data?.制品列表 ? `${Array.isArray(artifactsQ.data?.制品列表) ? (artifactsQ.data?.制品列表).length : 0} 个制品` : "暂无制品信息"
					})]
				})
			})
		]
...
function Agents() {
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
		...
		}), agents.length === 0 ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Card, { children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
			className: "text-sm text-dark-500 text-center py-8",
			children: "暂无智能体"
		}) }) : /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
...
function AgentCard({ agent }) {
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
		...
		children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
			...
			children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
				className: "flex items-center gap-2",
				children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Bot, { className: "w-4 h-4 text-accent-400" }), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
					className: "text-sm font-medium text-dark-100",
					children: agent.名称
				})]
			}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)(StatusBadge, { status: agent.状态 })]
		}), /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
			className: "space-y-3 text-xs",
			children: [
				/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
					className: "flex items-center justify-between text-dark-400",
					children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { children: "ID" }), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
						className: "font-mono text-dark-300",
						children: agent.ID
					})]
				}),
				/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
					className: "flex items-center justify-between text-dark-400",
					children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { children: "类别" }), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
						className: "text-dark-300",
						children: categoryLabels[agent.类别] ?? agent.类别
					})]
				}),
				/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
					className: "pt-2 border-t border-dark-700/30",
					children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
						className: "flex items-center gap-2 text-dark-400 mb-2",
						children: [
							/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Heart, { className: "w-3.5 h-3.5" }),
							/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { children: "健康检查" }),
							/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
								className: healthQ.data?.健康 ? "text-green-400" : "text-red-400",
								children: healthQ.isLoading ? "检查中..." : healthQ.data?.健康 ? "正常" : "异常"
							})
						]
					}), /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
						className: "flex items-center gap-2 text-dark-400",
						children: [
							/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Gauge, { className: "w-3.5 h-3.5" }),
							/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { children: "负载" }),
							/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
								className: "flex-1 h-1.5 bg-dark-700 rounded-full overflow-hidden ml-1",
								children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
							...
							/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
								className: "font-mono text-dark-300 w-10 text-right",
								children: loadData ? `${loadData.当前并发}/${loadData.最大并发}` : `${loadPercent}%`
							})
						]
					})]
				})
...
//#endregion
//#region src/pages/Approvals.tsx
function Approvals() {
	const qc = useQueryClient();
	...
	const decideMut = useMutation({
		mutationFn: ({ id, approve, feedback }) => api.approval.decide(id, {
			决策者: apiKey ? "api_user" : "api_user",
			批准: approve,
			反馈: feedback
		}),
		onSuccess: () => {
	...
	const items = data?.待处理审批列表 ?? data?.审批历史 ?? [];
	if (isLoading) return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Loading, {});
	if (error) return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(ErrorDisplay, { message: error.message });
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
		className: "space-y-6",
		children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
			className: "flex items-center justify-between",
			children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("h2", {
				...
				className: "flex gap-1 bg-dark-800/60 rounded-md p-0.5",
				children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("button", {
					onClick: () => setTab("pending"),
					className: `px-3 py-1.5 text-xs font-medium rounded transition-colors ${tab === "pending" ? "bg-accent-700/60 text-white" : "text-dark-400 hover:text-dark-200"}`,
					children: ["待处理 ", pendingQ.data?.总数 ? `(${pendingQ.data.总数})` : ""]
				}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("button", {
					onClick: () => setTab("history"),
					className: `px-3 py-1.5 text-xs font-medium rounded transition-colors ${tab === "history" ? "bg-accent-700/60 text-white" : "text-dark-400 hover:text-dark-200"}`,
					children: "历史"
				})]
			})]
		}), items.length === 0 ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Card, { children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
			className: "text-sm text-dark-500 text-center py-8",
			children: tab === "pending" ? "暂无待处理审批" : "暂无审批历史"
		}) }) : /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
			className: "space-y-3",
			children: items.map((item) => {
				const riskVariant = getVariant(item.风险级别 === "high" ? "danger" : item.风险级别 === "medium" ? "warning" : "success");
				return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
					className: "card-hover",
					children: [
						/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
							...
							children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
								...
								children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(StatusBadge, { status: item.状态 }), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
									className: `badge ${riskVariant === "danger" ? "badge-danger" : riskVariant === "warning" ? "badge-warning" : "badge-success"}`,
									children: {
										high: "高风险",
										medium: "中风险",
										low: "低风险"
								...
								className: "flex items-center gap-2 text-xs text-dark-500",
								children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Clock, { className: "w-3.5 h-3.5" }), item.创建时间]
							})]
						}),
						/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
							className: "flex items-center gap-4 text-xs text-dark-400 mb-3",
							children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("span", { children: ["流水线: ", /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
								className: "text-dark-200 font-mono",
								children: item.流水线ID
							})] }), /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("span", { children: ["阶段: ", /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
								className: "text-dark-200 font-mono",
								children: item.阶段ID
							})] })]
						}),
						item.状态 === "pending" && /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
							className: "flex items-center gap-3 pt-3 border-t border-dark-700/30",
							children: [
								...
								/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("button", {
									...
									children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(CircleCheckBig, { className: "w-3.5 h-3.5" }), " 批准"]
								}),
								/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("button", {
									onClick: () => decideMut.mutate({
										id: item.ID,
									...
									children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(CircleX, { className: "w-3.5 h-3.5" }), " 拒绝"]
								})
							]
						})
					]
...
function Config() {
	...
	const updateMut = useMutation({
		mutationFn: ({ key, value }) => api.config.update(key, value),
		onSuccess: () => {
	...
	if (configQ.isLoading) return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Loading, {});
	if (configQ.error) return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(ErrorDisplay, {
		message: configQ.error.message,
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
		...
		children: [
			...
			/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
				className: "flex gap-1 bg-dark-800/60 rounded-md p-0.5 w-fit",
				children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("button", {
					onClick: () => setTab("current"),
					className: `px-3 py-1.5 text-xs font-medium rounded transition-colors ${tab === "current" ? "bg-accent-700/60 text-white" : "text-dark-400 hover:text-dark-200"}`,
					children: "当前配置"
				}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("button", {
					onClick: () => setTab("merged"),
					className: `px-3 py-1.5 text-xs font-medium rounded transition-colors ${tab === "merged" ? "bg-accent-700/60 text-white" : "text-dark-400 hover:text-dark-200"}`,
					children: "合并后配置"
				})]
			}),
			/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Card, {
				title: "配置内容",
				action: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Settings, { className: "w-4 h-4 text-dark-500" }),
				children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
					className: "space-y-4",
					children: Object.entries(config).map(([section, value]) => /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("h4", {
						className: "text-xs font-semibold text-accent-400 mb-2 uppercase tracking-wider",
						children: section
					}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
						className: "bg-dark-900/60 rounded-md p-3 font-mono text-xs text-dark-300 space-y-1",
						children: typeof value === "object" && value !== null ? Object.entries(value).map(([k, v]) => /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
							className: "flex items-center gap-2",
							children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("span", {
								...
								children: typeof v === "object" && v !== null ? JSON.stringify(v, null, 2) : String(v)
							})]
						}, k)) : String(value)
					})] }, section))
				})
			...
			/* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Card, {
				title: "更新配置",
				children: [saveMsg && /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
					className: "mb-3 p-2 rounded bg-green-900/20 border border-green-800/30 text-xs text-green-400",
					children: saveMsg
				}), /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
					className: "space-y-3",
					children: [
						/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("label", {
							className: "text-xs text-dark-400 mb-1 block",
							children: "键路径"
						}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("input", {
							type: "text",
							value: editKey,
						...
						/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("button", {
							...
							children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Save, { className: "w-3.5 h-3.5" }), " 保存"]
						})
					]
				})]
			})
...
function App() {
	return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(ThemeProvider, { children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(AuthProvider, { children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(QueryClientProvider, {
		client: queryClient,
		children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(HashRouter, { children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Routes, { children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Route, {
			...
			children: [
				...
				/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Route, {
					path: "/pipelines",
					element: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Pipelines, {})
				}),
				/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Route, {
					path: "/pipelines/:id",
					element: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(PipelineDetail, {})
				}),
				/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Route, {
					path: "/agents",
					element: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Agents, {})
				}),
				/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Route, {
					path: "/approvals",
					element: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Approvals, {})
				}),
				/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Route, {
					path: "/config",
					element: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Config, {})
				})
			]
		}) }) })
	}) }) });
